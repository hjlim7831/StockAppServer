...
public class RealtimeComponent {
	...
	/**
	 * 실시간 환율 정보 하나만를 하나은행 API에서 가져오는 함수
	 * **/
	public RealtimeExchangeDto[] getRealtimeExchange(String name) {
		// 실시간 환율(달러 : USD, 엔화 : JPY, 유로 : EUR, 위안 : CNY)을 가져올 URL
		String url = "https://quotation-api-cdn.dunamu.com/v1/forex/recent?codes=FRX.KRW" + name;
